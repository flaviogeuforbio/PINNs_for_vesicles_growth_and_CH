...
def parse_args():
    ...
    parser.add_argument("--psi_in", type=float, default=0.6, help = "IC for psi inside the vesicle (homogeneous concentration)")
    parser.add_argument("--psi_out", type=float, default=0.2, help = "IC for psi outside the vesicle (homogeneous concentration)")
