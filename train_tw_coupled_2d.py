...
from train_coupled_2d import parse_args, train_model, train_lbfgs
...
if __name__ == "__main__":
    ...
    from utils_coupled_2d import make_ic_from_previous_model
    ...
    out_dir = Path("artifacts/timewindowing") / args.run_name
    ...
    for segment_idx in range(n_segments):
        ...
        plt.title(f"Coupled AC-CH 2D training losses (segment {segment_idx})")
        plt.legend()
